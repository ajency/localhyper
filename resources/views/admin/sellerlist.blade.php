          ...
          <tbody>
           @foreach($sellers as $seller)
              <tr >
                ...
                <td>{{ $seller['firstFiveBrands'] }} @if($seller['firstFiveBrands'] != '')<a type="button" class="btn btn-link" data-container="body" data-toggle="popover" data-placement="right" data-content="{{ $seller['brands'] }}">
  View More
</a> @endif </td>
