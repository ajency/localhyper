...
<div class="page-container row-fluid">
  ...
  <!-- END MINI-PROFILE -->
    ...
    <p class="menu-title" onclick="location.href='{{ url('admin/product/onlineproductprices') }}'">Online Price Configuration <span class="text-right"> @if($activeMenu=='productprice')<i class="fa fa-check text-success"></i>@endif</span></p>   
